...
void MyFrame::obj_movementSpeed_button_clicked(wxCommandEvent& event)
{
    Data_Handler dh;
    std::string newvalue;
    newvalue = obj_movementSpeed_textbox->GetValue();
    dh.Object_Container[0].MovementSpeed = std::stof(newvalue);
